                            ...
                            <div class="ibox-content">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#">创建专栏</a></li>
                                    </ul>
                                        ...
                                        <div id="tab-1" class="tab-pane active">
                                            <div class="panel-body">
                                                <form class="form-horizontal" action="#" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label">Logo图片：<span class="tip">*</span></label>
                                                        <div class="col-sm-8">
                                                            <div id="uploader">
                                                                <!--用来存放item-->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <textarea id="introduce" name="introduce" class="form-control" cols="5" maxlength="200"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-sm-8 col-sm-offset-2">
                                                            <input type="hidden" name="logo" id="logo">
                                                            <input type="button" class="btn btn-primary block full-width" value="创建" onclick="addCategory()">
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
<script type="text/javascript">
    ...
    function addCategory() {
        ...
        if (SWUtils.isEmpty(logo)) {
            SWDialog.errorTips("Logo图片不能为空");
            return;
        }
        ...
        $.post("${rc.contextPath}/user/group/add", {categoryId:categoryId, name:name, introduce:introduce, logo:logo}, function(data) {
            if (data.code == 20) {
